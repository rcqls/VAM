...
AtIntensity.maintenance.policy <- function(level=1) {}
AtVirtualAge.maintenance.policy <- function(level=1) {} 
AtFailureProbability.maintenance.policy <- function(level=0.5) {}
